                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ URL::to('/') }}"><img src="{{ asset('frontend/images/logo.png') }}"
                                    alt="" /></a>
                        </div>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{ URL::to('/logout-checkout') }}"><i class="fa fa-lock"></i> Đăng
                                        xuất</a></li>
                                <li><a href="{{ URL::to('/order-history') }}"><i class="fa fa-lock"></i> Lịch sử</a></li>
                                <?php } else { ?>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'frontend/images/101.webp' }}" class="girl img-responsive"
                                        alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'frontend/images/102.webp' }}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{ 'frontend/images/pricing.png' }}" class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'frontend/images/103.webp' }}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{ 'frontend/images/pricing.png' }}" class="pricing" alt="" />
                                </div>
                            </div>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach ($brand as $key => $brand)
                                        <li><a href="{{ URL::to('/thuong-hieu-san-pham/' . $brand->brand_slug) }}">
                                                <span class="pull-right">(<span>{{ $brand->brand_product_qty }}</span>)</span>{{ $brand->brand_name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'frontend/images/101.webp' }}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'frontend/images/102.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'frontend/images/103.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'frontend/images/104.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>

                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/all-customers') }}">Liệt kê tài khoản</a>
                                </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/overview-report') }}">Báo cáo doanh thu</a></li>
                                {{-- <li><a href="{{ URL::to('/all-product') }}">Báo cáo kho hàng</a></li>
                                <li><a href="{{ URL::to('/all-product') }}">Báo cáo lợi nhuận</a></li> --}}
                            </ul>
                        </li>
